const statusClass: Record<string, string> = {
  ...
  deferred: "bg-amber-50 text-amber border-amber-200",
  running: "bg-blue-50 text-blue-700 border-blue-200",
  succeeded: "bg-emerald-50 text-mint border-emerald-200",
  complete: "bg-emerald-50 text-mint border-emerald-200",
  completed: "bg-emerald-50 text-mint border-emerald-200",
  cancel_requested: "bg-amber-50 text-amber border-amber-200",
  cancelled: "bg-slate-100 text-slate-700 border-slate-200",
  canceled: "bg-slate-100 text-slate-700 border-slate-200",
  failed: "bg-red-50 text-coral border-red-200",
  binding_blocked: "bg-red-50 text-coral border-red-200",
  binding_eligible: "bg-emerald-50 text-mint border-emerald-200",
