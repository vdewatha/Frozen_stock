...
const configuredApi = process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://127.0.0.1:8000";
const API_BASE_URL = (/^https?:\/\//.test(configuredApi) ? configuredApi : `https://${configuredApi}`).replace(/\/$/, "");
